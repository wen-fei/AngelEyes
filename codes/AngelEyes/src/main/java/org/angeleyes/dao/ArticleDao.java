...
public interface ArticleDao {
     ...
     * @return
     */
    int addArticle(@Param("article_title") String article_title,@Param("article_authorID") Long article_authorID,
     ...
     * @return
     */
    List<Article> getArticleByTime(@Param("startTime") Timestamp startTime, @Param("endTime") Timestamp endTime);
