...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/style/css/login/login.css">
    <link rel="stylesheet" href="<%=request.getContextPath() %>/style/css/bootstrap.css">
    <link rel="stylesheet" href="<%=request.getContextPath() %>/style/css/login/logincommon.css">
</head>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/style/js/app/bootstrapValidator.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/style/js/app/formValidator.js"></script>
</body>
</html>
