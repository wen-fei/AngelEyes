                                        ...
                                        <tr>
                                            ...
                                            <th class="new">
                                                ...
                                                <div class="tl_tit cl">
                                                    ...
                                                    <h3 id="article_title">
                                                        <input type="text" hidden="hidden" id="isHot_${al.article_id}" value="${al.article_is_hot}">
                                                        <input type="text" hidden="hidden" id="isJing_${al.article_id}" value="${al.article_is_good}">
